...
public class EscapeThread extends Thread {
    ...
    private final EscapeView view; // l'objet SurfaceView que nous verrons plus bas
    ...
    public EscapeThread(EscapeView view) {
        this.view = view;
    }
